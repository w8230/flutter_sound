...
class SysCommonList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SysCommonListBody(),
    );
  }
}

class SysCommonListBody extends StatefulWidget {
  SysCommonListBody({Key key}) : super(key: key);

  @override
  _SysCommonListBody createState() => _SysCommonListBody();
}

class _SysCommonListBody extends State<SysCommonListBody> {
  // width 전역 변수
  double _width;
  int _counter = 0;
  String test;
